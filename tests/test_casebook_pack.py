"""Regression checks for the signal-sys-process-index casebook."""
...
from casebook.harness import assert_expected, signal_sys_process_index_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(signal_sys_process_index_summary(), assert_expected())
